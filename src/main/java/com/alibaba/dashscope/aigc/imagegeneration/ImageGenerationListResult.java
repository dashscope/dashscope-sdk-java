...
@Data
@Slf4j
public class ImageGenerationListResult {
  ...
  public static ImageGenerationListResult fromDashScopeResult(DashScopeResult dashScopeResult) {
    if (dashScopeResult.getOutput() != null) {
      ImageGenerationListResult rs =
          (JsonUtils.fromJsonObject(
              (JsonObject) dashScopeResult.getOutput(), ImageGenerationListResult.class));
