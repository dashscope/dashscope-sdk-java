...
public abstract class TingWuRealtimeCallback {
   ...
   *
   * <p>param errorCode The error code associated with the error. param errorMsg The error message
   ...
   *
   * <p>param taskId The unique identifier for the dialog. param content The content of the response
   * as a JsonObject.
   */
   ...
   *
   * <p>param taskId The unique identifier for the dialog. param content The content of the speech
   * as a JsonObject.
   */
   ...
   *
   * <p>param taskId The unique identifier for the dialog. param dataId for this task
   */
