 ...
 *
 * <p>author songsong.shao date 2025/4/27
 */
public abstract class MultiModalDialogCallback {
   ...
   *
   * <p>param dialogId The unique identifier for the dialog. param errorCode The error code
   * associated with the error. param errorMsg The error message associated with the error.
   */
   ...
   *
   * <p>param state The new state of the conversation.
   */
   ...
   *
   * <p>param audioData The audio data as a ByteBuffer.
   */
   ...
   *
   * <p>param dialogId The unique identifier for the dialog.
   */
   ...
   *
   * <p>param dialogId The unique identifier for the dialog. param content The content of the
   ...
   *
   * <p>param dialogId The unique identifier for the dialog. param content The content of the speech
   * as a JsonObject.
   */
