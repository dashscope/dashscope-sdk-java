...
public class HttpSpeechSynthesizer {
  ...
  private final SynchronizeHalfDuplexApi<HttpSpeechSynthesisParam> syncApi;

  @Getter private ByteBuffer accumulatedAudioData;
  ...
  public HttpSpeechSynthesizer() {
    ...
    this.syncApi = new SynchronizeHalfDuplexApi<>(serviceOption);
  }
  ...
  public ByteBuffer callAndReturnAudio(HttpSpeechSynthesisParam param)
    ...
    try {
      ...
      accumulatedAudioData = ByteBuffer.wrap(audioBuffer.toByteArray());
