...
public class ParamUtils {
   ...
   * @return true if model is qwen{n} where n is greater than or equal to 3, false otherwise
   */
  ...
  /**
   * Check if the increment_output parameter should be modified for the given model
   *
   * @param modelName the model name to check
   * @return false if model contains "tts", "omni", or "qwen-deep-research", true otherwise
   */
