...
public final class PreprocessInputImage {
  ...
  public static CheckAndUploadImageResult checkAndUploadImages(
      String model, Map<String, String> values, String apiKey, OSSUploadCertificate certificate)
    ...
    for (Map.Entry<String, String> entry : values.entrySet()) {
      ...
      CheckAndUploadOneImageResult result = checkAndUploadOneImage(model, apiKey, v, cert);
   ...
   * @throws UploadFileException If upload fails
   */
  public static boolean checkAndUploadImage(String model, Map<String, String> values, String apiKey)
      throws NoApiKeyException, UploadFileException {
    CheckAndUploadImageResult result = checkAndUploadImages(model, values, apiKey, null);
  ...
  public static CheckAndUploadOneImageResult checkAndUploadOneImage(
      String model, String apiKey, String value, OSSUploadCertificate certificate)
      throws NoApiKeyException, UploadFileException {
   ...
   * @throws UploadFileException If upload fails
   */
  public static String checkAndUploadImage(String model, String apiKey, String value)
      throws NoApiKeyException, UploadFileException {
    CheckAndUploadOneImageResult result = checkAndUploadOneImage(model, apiKey, value, null);
