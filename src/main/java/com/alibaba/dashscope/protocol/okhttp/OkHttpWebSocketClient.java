...
public class OkHttpWebSocketClient extends WebSocketListener
  ...
  /**
   * Hook method called before sending the start message. Subclasses may override to add
   * additional logging or pre-processing.
   */
  ...
  protected CompletableFuture<Void> sendStreamRequest(FullDuplexRequest req) {
    CompletableFuture<Void> future =
        CompletableFuture.runAsync(() -> executeStreamRequest(req));
    return future;
  }
