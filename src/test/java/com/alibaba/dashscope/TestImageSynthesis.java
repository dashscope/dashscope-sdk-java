...
public class TestImageSynthesis {
  ...
  public void testImageSynthesisNormal()
    ...
    String responseBody =
        "{\"request_id\":\"39\",\"output\":{\"task_id\":\"e4\",\"task_status\":\"SUCCEEDED\",\"results\":[{\"url\":\"https://1\"},{\"url\":\"https://2\"},{\"url\":\"https://\"},{\"url\":\"https://4\"}],\"task_metrics\":{\"TOTAL\":4,\"SUCCEEDED\":4,\"FAILED\":0}},\"usage\":{\"image_count\":4},\"headers\":{\"content-length\":\"281\",\"content-type\":\"application/json; charset=utf-8\"},\"status_code\":200,\"code\":\"\",\"message\":\"\"}";
    server.enqueue(
        new MockResponse()
